...
+ [Nejdå. Jag lovar att inget farligt kommer hända! Du är ju med mig.]
    Nja... det känns inte helt rätt.
    Jag tror att min ångest hade varit typ 9 av 10 om jag går dit direkt.
    -> efter_forsta_val

+ [Kom igen, du fixar det. Tro på dig själv!]
    Nja... det känns inte helt rätt.
    Jag tror att min ångest hade varit typ 9 av 10 om jag går dit direkt.
    -> efter_forsta_val

=== efter_forsta_val ===
    + [Du kanske behöver vänta tills det känns bättre först.]
        Ja... Jag stannar hellre här.
        Då kan i alla fall inget läskigt hända.
        Vi ses senare.
        -> END
